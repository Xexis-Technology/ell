...
<div class="max-w-3xl mx-auto px-4 py-12">
  ...
  <form method="post" class="card p-6 mt-4 space-y-4"><?= csrf_field() ?>
    <div><label class="label" for="booking_number">Booking number</label><input id="booking_number" name="booking_number" class="input" required pattern="[0-9]{8}"></div>
    <div><label class="label" for="email">Booking email</label><input id="email" type="email" name="email" class="input" required></div>
